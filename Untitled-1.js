...
with (document) {
  writeln("<style>");
  writeln(
    "td.calendarDateInput {letter-spacing:normal;line-height:normal;font-family:" +
      FontFamily +
  ...
  for (var A = 0; A < C; A++) {
    ...
    for (var B = 1; B <= 7; B++) {
      ...
      if (Day >= 1 && Day <= this.displayed.dayCount) {
        ...
        D +=
          '<td align="center" class="calendarDateInput" style="cursor:default;height:' +
          CellHeight +
          ";width:" +
          CellWidth +
          ";" +
        ...
        D +=
          '<td class="calendarDateInput" style="height:' +
          CellHeight +
          '">&nbsp;</td>';
      }
    }
  ...
  if (arguments.length == 0) {
    document.writeln(
      '<span style="color:red;font-size:' +
        ...
        "px;font-family:" +
        FontFamily +
        ";\">ERROR: Missing required parameter in call to 'DateInput': [name of hidden date field].</span>"
    );
  } else {
    ...
    with (document) {
      ...
      writeln(
        '<select class="calendarDateInput" style="font-size:16px;" id="' +
          DateName +
          '_Month_ID" onChange="' +
          DateName +
      ...
      writeln(
        "<select" +
          InitialStatus +
          ' class="calendarDateInput" style="font-size:16px;" id="' +
          DateName +
          '_Day_ID" onChange="' +
          DateName +
      ...
      writeln(
        "<input" +
          InitialStatus +
          ' class="calendarDateInput" style="font-size:16px;" type="text" id="' +
          DateName +
      ...
      write(
        '<td valign="middle">' +
          ...
          DateName +
          '_Object.iconHover(false)"><img src="' +
          ImageURL +
      ...
      writeln(
        '<td id="' +
          DateName +
          '_Previous_ID" style="cursor:default" align="center" class="calendarDateInput" style="height:' +
          CellHeight +
          '" onClick="' +
          DateName +
      ...
      writeln(
        '<td id="' +
          DateName +
          '_Current_ID" style="cursor:pointer" align="center" class="calendarDateInput" style="height:' +
          CellHeight +
          '" colspan="5" onClick="' +
          DateName +
      ...
      writeln(
        '<td id="' +
          DateName +
          '_Next_ID" style="cursor:default" align="center" class="calendarDateInput" style="height:' +
          CellHeight +
          '" onClick="' +
          DateName +
      ...
      for (var w = 0; w < 7; w++) {
        writeln(
          '<td width="' +
            CellWidth +
            '" align="center" class="calendarDateInput" style="height:' +
            CellHeight +
            ";width:" +
            CellWidth +
